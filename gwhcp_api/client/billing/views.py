...
from client.billing import serializers
...
class Create(generics.CreateAPIView):
    ...
    gacl = {
        'view': ['client_billing.view_billingprofile'],
        'add': ['client_billing.add_billingprofile']
    }
...
class Delete(generics.RetrieveDestroyAPIView):
    ...
    gacl = {
        'view': ['client_billing.view_billingprofile'],
        'delete': ['client_billing.delete_billingprofile']
    }
...
class Profile(generics.RetrieveUpdateAPIView):
    ...
    gacl = {
        'view': ['client_billing.view_billingprofile'],
        'change': ['client_billing.change_billingprofile']
    }
