...
class CreateSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        ...
        coupon: models.Coupon = validated_data['coupon']
        ...
        if coupon:
            billing_invoice.set_item('debit', store_product_price, coupon=coupon)
            billing_invoice.set_item('charge', store_product_price, coupon=coupon, transaction=payment,
                                     transaction_type='auth_capture')
        else:
            billing_invoice.set_item('debit', store_product_price)
            billing_invoice.set_item('charge', store_product_price, transaction=payment,
                                     transaction_type='auth_capture')
        ...
        order_object = models.Order.objects.create(
            ...
            coupon=coupon,
            product_profile=product_profile,
            payment_status=payment['transaction_type'],
            status='new'
        )
        ...
        # Fraud Strings
        fraud_string = fraud.Fraud(order=order_object)
        fraud_string.set_item(account=account, billing_profile=billing_profile)
        fraud_string.review()
