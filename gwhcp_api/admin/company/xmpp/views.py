...
from admin.company.xmpp import models
from admin.company.xmpp import serializers
...
class CreateAccount(generics.CreateAPIView):
    ...
    gacl = {
        'view': ['admin_company_xmpp.view_prosodyaccount'],
        'add': ['admin_company_xmpp.add_prosodyaccount']
    }
...
class Delete(generics.RetrieveDestroyAPIView):
    ...
    gacl = {
        'view': ['admin_company_xmpp.view_prosodyaccount'],
        'delete': ['admin_company_xmpp.delete_prosodyaccount']
    }
...
class Profile(generics.RetrieveUpdateAPIView):
    ...
    gacl = {
        'view': ['admin_company_xmpp.view_prosodyaccount'],
        'change': ['admin_company_xmpp.change_prosodyaccount']
    }
